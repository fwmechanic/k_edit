...
static void doswap(int swap, char *p, size_t n)
{
 if (swap)
 {
  char *a=p;
...
#else
 // 20091215 kgoodwin luaL_openlib is deprecated in Lua 5.1 if LUA_COMPAT_OPENLIB is off
