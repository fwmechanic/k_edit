...
static const byte opproperties[] = {
  // 20101025 kgoodwin patch from http://lua-users.org/lists/lua-l/2010-07/msg00551.html
  /* IAny */            ISCHECK | ISJMP,
  /* IChar */           ISCHECK | ISJMP,
...
static const char *match (lua_State *L,
  ...
  for (;;) {
//#if defined(DEBUG)  20090627 kgoodwin DEBUG is normally defined but we don't want this!
#if 0
...
// 20101025 kgoodwin removed for 0.9 per http://lua-users.org/lists/lua-l/2010-08/msg00378.html
...
static void createcat (lua_State *L, const char *catname, int (CDECL__ catf) (int)) {  //20081110 kgoodwin added 'CDECL__' to get to compile
  Instruction *p = newcharset(L);
  int i;
