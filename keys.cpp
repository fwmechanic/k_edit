...
STATIC_CONST TKyCd2KyNameTbl KyCd2KyNameTbl[] = {
      ...
      { EdKC_ca_f1           , "ctrl+alt+f1"    },
      { EdKC_ca_f2           , "ctrl+alt+f2"    },
      { EdKC_ca_f3           , "ctrl+alt+f3"    },
      { EdKC_ca_f4           , "ctrl+alt+f4"    },
      { EdKC_ca_f5           , "ctrl+alt+f5"    },
      { EdKC_ca_f6           , "ctrl+alt+f6"    },
      { EdKC_ca_f7           , "ctrl+alt+f7"    },
      { EdKC_ca_f8           , "ctrl+alt+f8"    },
      { EdKC_ca_f9           , "ctrl+alt+f9"    },
      { EdKC_ca_f10          , "ctrl+alt+f10"   },
      { EdKC_ca_f11          , "ctrl+alt+f11"   },
      { EdKC_ca_f12          , "ctrl+alt+f12"   },
