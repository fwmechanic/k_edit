...
K builds to a 64-bit binary/exe for Win32 (Console) and Linux (ncurses) platforms.  K is written in C++17 with http://www.lua.org/versions.html#5.1[Lua 5.1] embedded.
