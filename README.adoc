...
K runs on Win32 (Console) and Linux (ncurses) platforms, in 32- and 64-bit form.  K is written in C++17 with http://www.lua.org/versions.html#5.1[Lua 5.1] embedded.
